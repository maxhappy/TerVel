...
public class GameScreen extends GLScreen
{
    ...
    public static  BatcherBridge batcherBridge;
    public static  tools_seting_bridge ts_bridge;
    ...
    public GameScreen(Game game)
  {
    ...
    {  gl = glGraphics.getGL();
    	...
    	if(NativeFun.setgetstate(-1)==4||NativeFun.setgetstate(-1)==8)//||NativeFun.setgetstate(-1)==4)
    		...
    		((Activity) TerVel.contex).runOnUiThread(new Runnable(){public void run() 
    		{
    			GLGame.layout.bringChildToFront(GLGame.adlay);
    			GLGame.adView.setVisibility(View.VISIBLE);}}); 
    	else
    		((Activity) TerVel.contex).runOnUiThread(new Runnable(){public void run() {GLGame.adView.setVisibility(View.GONE);}});	
        ...
        if(inductionlabs.nativ.Game.gd.regionheight==null||inductionlabs.nativ.Game.gd.regionwidth==null)
        inductionlabs.nativ.Game.Init();
